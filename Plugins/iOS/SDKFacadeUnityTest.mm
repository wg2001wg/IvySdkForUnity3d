...
@implementation SDKFacadeUnityTest
...
extern "C" {
    ...
    {
        [[[SDKFacadeUnityTest alloc] init] onCheckSubscriptionResult:payId isActive:YES];
    }
    
    void restorePayments()
    {
        toast("restore success");
        [[[SDKFacadeUnityTest alloc] init] onRestoreSuccess:1];
    }
