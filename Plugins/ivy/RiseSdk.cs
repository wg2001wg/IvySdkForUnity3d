...
{
    public static string payUrl_
    {
        get
        {
            var url = PayUrlFunc?.Invoke();
    ...
    public static Func<string> PayUrlFunc;
...
//    }
    ...
    public void setUserProperty(string v1, string v2)
    {
    ...
    public bool CheckSubscriptionActive(int billingId)
    {
        if (_class != null)
        {
            try
            {
                ...
                return _class.CallStatic<bool>("isSubscriptionActive", billingId);
            }
            catch (Exception e)
            {
                return false; 
    ...
    public void ChangeSkuWithPayload(int oldBillingID,int newBillingID,string payloadData)
    {
        SetPayVerifyUrl(PayUrlFunc?.Invoke());
        payloadData = System.Uri.EscapeDataString(payloadData);
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.PayWithPayload(newBillingID, payloadData);
#else
        if (_class != null) {
            _class.CallStatic ("changeSku", oldBillingID, newBillingID, payloadData);
        }
#endif
    }
    ...
    public void PayWithPayload(int billingId, string payloadData)
  {
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("GetFreeMemSize");
#endif
        if (_class!=null)
        {
            var s = _class.CallStatic<long>("getFreeMem");
            if(s>=0)
                return s;
        }
        return -1L;
    ...
    public string GetKeyHashSha1()
    {
        if (_class != null) {
            return _class.CallStatic<string> ("getKeyHashSha1");
        }
        return "";
    }
    ...
    /// => {to do something};
    /// </summary>
    public void LoginNoAnonymous() {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast ("loginNoAnonymous");
#endif
        if (_class != null) {
            _class.CallStatic ("loginNoAnonymous");
        }
    }

    public void LoginNoAnonymousCancelable()
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("loginNoAnonymousCancelable");
#endif
        if (_class != null)
        {
            _class.CallStatic("loginNoAnonymousCancelable");
        }
    }
    ...
    {
#if UNITY_EDITOR
        Debug.Log("VerifyIdCard");
#endif
        if (_class != null)
        {
            _class.CallStatic("verifyIdCard");
        }
    }

    public void SetIdCardVerified(int age)
    {
#if UNITY_EDITOR
        Debug.Log("SetIdCardVerified");
#endif
        if (_class != null)
        {
            _class.CallStatic("setIdCardVerified",age);
        }
    }
...
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast ("getIdCardVerifyedAge");
#endif
        if (_class != null) {
            return _class.CallStatic<int> ("getIdCardVerifyedAge");
        } else {
            return 0;
        }
    }
    ...
    public bool HasPlatformQuit()
    {
        ...
        {
            return _class.CallStatic<bool>("hasPlatformQuit");
        }
    }
    ...
    /// 取消本地通知
    /// </summary>
    /// <param name="key">本地通知表示，通知的id</param>
    public void CancelLocalNotification(string key)
    {
        if (_class != null)
        {
            _class.CallStatic("cancelLocalMessage", key);
        }
    }
 ...
 */
    ...
    #endregion
    //
    #region showGameProtocolDialog   showPrivacyDialog  showUserAgreementDialog
    public void ShowGameProtocolDialog()
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("ShowGameProtocolDialog");
#endif
        if (_class != null)
        {
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("ShowPrivacyDialog");
#endif
        if (_class != null)
        {
            _class.CallStatic("showPrivacyDialog");
        }
    }
    public void ShowUserAgreementDialog()
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("ShowUserAgreementDialog");
#endif
        if (_class != null)
        {
            _class.CallStatic("showUserAgreementDialog");
        }
    }
    #endregion
    ...
    {
#if UNITY_EDITOR
        //RiseSdkListener.Instance.onLoginGoogleSuccess(SystemInfo.deviceUniqueIdentifier);
        RiseSdkListener.Instance.onLoginGoogleFailure();
#else
        if (_class != null)
        {
    ...
    [DllImport("__Internal")]
    private static extern void showNativeAdWithFrame(string tag, float x, float y, float width, float height,
        string configJson);
    ...
    [DllImport("__Internal")]
    private static extern void pushLocalNotification(string key, string title, string msg, long pushTime, int interval,
        bool useSound, string soundName, string userInfo);

    [DllImport("__Internal")]
    private static extern void pushLocalNotificationWithDateStr(string key, string title, string msg, string dateStr,
        int interval, bool useSound, string soundName, string userInfo);

    [DllImport("__Internal")]
    private static extern void pushRemoteNotification(string key, string title, string content, long pushTime,
        bool useLocalTimeZone, string facebookIds, string uuids, string topic, int iosBadge, bool useSound,
        string soundName, string dataJson);
    ...
    [DllImport("__Internal")]
    private static extern long getFreeMem();
    ...
    [DllImport("__Internal")]
    private static extern void loginNoAnonymous();
    [DllImport("__Internal")]
    private static extern void loginNoAnonymousCancelable();
    [DllImport("__Internal")]
    private static extern void setIdCardVerified(int age);
    
    [DllImport("__Internal")]
    private static extern int getIdCardVerifyedAge();

    [DllImport("__Internal")]
    private static extern void showGameProtocolDialog();

    [DllImport("__Internal")]
    private static extern void showPrivacyDialog();

    [DllImport("__Internal")]
    private static extern void showUserAgreementDialog();

    [DllImport("__Internal")]
    private static extern void joinQQGroup(string id, string key);
 ...
 */
    ...
    {
#if UNITY_EDITOR
        RiseSdkListener.Instance.StartCoroutine(delayStart((string t) => RiseEditorAd.EditorAdInstance.ShowAd(t), tag,
            delayShowSeconds));
#else
...
#if UNITY_EDITOR
        RiseSdkListener.Instance.StartCoroutine(delayStart((string t) => RiseEditorAd.EditorAdInstance.ShowAd(t), tag,
            (float) (delayShowSeconds * delayTimeInterval)));
#else
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("SetIdCardVerified : " + age);
#endif
        setIdCardVerified(age);
    }
    ...
    public int GetIdCardVerifyedAge() {
        ...
        RiseEditorAd.EditorAdInstance.Toast ("getIdCardVerifyedAge");
#endif
        return getIdCardVerifyedAge();
    }
    
    public void LoginNoAnonymous() {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast ("loginNoAnonymous");
        RiseSdkListener.Instance.onReceiveLoginResult("0");
#endif
        loginNoAnonymous();
    }
...
#if UNITY_EDITOR
        return
            "{\"id\":\"12345678\", \"name\":\"hahaha\", \"picture\":\"http://img.qq1234.org/uploads/allimg/141205/3_141205195713_3.jpg\"}";
#else
        return me ();
#endif
    }
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("Track: " + category + ", action: " + action + ", label: " + label +
                                            ", value: " + value);
#else
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("Umeng, buy, item: " + itemName + ", count: " + count + ", price: " +
                                            price);
#else
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("Umeng, use, item: " + itemName + ", number: " + number + ", price: " +
                                            price);
#else
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("Umeng, bonus, item: " + itemName + ", number: " + number + ", price: " +
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("ShowSignInWithApple");
        return false;
#else
        return showSignInWithApple(x, y, w, h, useBlackBackgrounds);
#endif
    }
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("HideSignInWithApple");
#else
        hideSignInWithApple();
#endif
    }
     ...
     */
    public void PushLocalNotification(string key, string title, string msg, long pushTime, int interval, bool useSound,
        string soundName, string userInfo)
    {
#if UNITY_EDITOR
    ...
    /** 发送本地通知
     ...
     @param userInfo 用户自定义数据，当点击通知打开应用的时候获取到
     */
    public void PushLocalNotificationWithDateStr(string key, string title, string msg, string dateStr, int interval,
        bool useSound, string soundName, string userInfo)
    {
#if UNITY_EDITOR
    ...
    /// <param name="soundName">特定提示音名字，需要打到包体中</param>
    /// <param name="userInfo">用户自定义数据，当点击通知打开应用的时候获取到</param>
    public void PushNotification(string key, string title, string content, long pushTime, bool localTimeZone,
        string fbIds, string uuids, string topics, int iosBadge, bool useSound, string soundName, string userInfo)
    {
#if UNITY_EDITOR
...
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("ShowGameProtocolDialog");
        RiseSdkListener.Instance.onPrivacyAccept("0");
#else
    ...
    {
#if UNITY_EDITOR
        RiseEditorAd.EditorAdInstance.Toast("JoinQQGroup");
#else
        joinQQGroup(id, key);
#endif
    }
    ...
    /// 渠道名称
    /// </summary>
    public const int CONFIG_KEY_CHANNEL = 20;
...
public enum AdEventType : int
{
    ...
    private class RiseEditorAd : MonoBehaviour
    {
        ...
        public static bool ApplicationIsQuiting { get; set; } = false;
        ...
        public static RiseEditorAd EditorAdInstance
        {
            get
            {
                if (_editorAdInstance == null&&!ApplicationIsQuiting)
                {
        ...
        void OnGUI()
        {
            ...
            if (iconAdShow)
            {
                ...
                //GUI.color = new Color (1, 0, 0, 1);
                if (GUI.Button(
                    new Rect(Screen.width * iconAdXPercent, Screen.height * iconAdYPercent, iconAdWidth, iconAdWidth),
                    iconAdContent))
                {
                }
                        ...
                        if (!string.IsNullOrEmpty(data))
                        {
                            ...
                            if (obj != null && obj.ContainsKey("status"))
                            {
                                if (obj["status"].ToString().Equals("1"))
                                {
                                    ...
                                    {
                                        RiseSdkListener.Instance.onPaymentSuccessWithPayload(
                                            billingId + "|" + obj["payload"].ToString());
                                    }
                                    else
                                    {
